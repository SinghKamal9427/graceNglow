$(document).ready(function(){
  ...
  $('.colors-large a').click(function(){return false;});
	...
	$('.add_to_cart').click(function(){
		...
		const cartsLocalItems  = localStorage.getItem('cartItems')
		if(!cartsLocalItems) {
			cartItems.push(product)
		} else {
			cartItems = JSON.parse(cartsLocalItems).slice();
			cartItems.push(product)
		}
		...
		setTimeout(function(){
			...
			var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='"+productImage+"' alt='' /></div><span>"+productName+"</span><strong>INR"+productPrice+"+</strong><div class='cart-item-border'></div><div class='delete-item'></div></div>";			
